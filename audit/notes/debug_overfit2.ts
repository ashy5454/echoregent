...
for (const city of ['Dallas', 'Portland']) {
  ...
  console.log('memoryFrame.unresolved:', r.memoryFrame?.unresolved)
  console.log('memoryFrame.entities:', r.memoryFrame?.entities)
  console.log('compressed contains city text?', r.compressed.some((m) => m.content.includes(city)))
  console.log()
}
