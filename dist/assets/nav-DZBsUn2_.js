...
<nav class="er-nav">
  <div class="er-nav-inner">
    <a class="er-nav-logo" href="/index.html">${l}<span class="er-nav-wordmark">EchoRegent</span></a>
...
</footer>`;function n(){const e=document.getElementById("er-nav");e?e.outerHTML=o:document.body.insertAdjacentHTML("afterbegin",o);const t=document.getElementById("er-footer");t?t.outerHTML=i:document.body.insertAdjacentHTML("beforeend",i);const c=window.location.pathname;document.querySelectorAll(".er-nav-link[href]").forEach(r=>{const s=r.getAttribute("href");if(!s)return;const a=s.split("/").pop(),d=c.split("/").pop()||"index.html";a&&a!=="index.html"&&d===a&&r.classList.add("active")}),document.querySelectorAll(".er-sidebar-link").forEach(r=>{r.href===window.location.href&&r.classList.add("active")}),document.querySelectorAll(".er-dropdown").forEach(r=>{const s=r.querySelector("button");s&&s.addEventListener("click",a=>{a.stopPropagation();const d=r.classList.contains("open");document.querySelectorAll(".er-dropdown.open").forEach(h=>h.classList.remove("open")),d||r.classList.add("open")})}),document.addEventListener("click",()=>{document.querySelectorAll(".er-dropdown.open").forEach(r=>r.classList.remove("open"))}),document.querySelectorAll('a[href^="#"]').forEach(r=>{r.addEventListener("click",s=>{const a=document.querySelector(r.getAttribute("href"));a&&(s.preventDefault(),a.scrollIntoView({behavior:"smooth",block:"start"}))})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()})();
